...
const experiencias = ref([
    { id: 1, src: icono1, parrafo: 'Diseñé y desarrollé funcionalidades clave para la plataforma de comercio electrónico utilizando Java y Spring Boot.' },
    { id: 2, src: icono2, parrafo: 'Implementé APIs RESTful para mejorar la integración con aplicaciones móviles y mejorar la experiencia del usuario.' },
    { id: 3, src: icono3, parrafo: 'Colaboré con el equipo de diseño UX/UI para asegurar una interfaz amigable y accesible.' },
    { id: 4, src: icono4, parrafo: 'Optimicé la base de datos relacional, logrando reducir los tiempos de respuesta en un 30%.' },
    { id: 5, src: icono5, parrafo: 'Trabajé con metodologías ágiles (Scrum), participando en reuniones diarias y sprints de dos semanas.' },
]);
</script>
