...
const intereses = ref([
    ...
    'El ciclismo es un deporte que combina ejercicio físico y exploración de entornos al aire libre. Puede practicarse en carreteras, montañas o parques y es ideal para mejorar la resistencia física.',
    'Aprendo idiomas: Aprender un nuevo idioma es una actividad intelectual enriquecedora que expande el conocimiento cultural y la capacidad de comunicación.',
    ''
]);
</script>
