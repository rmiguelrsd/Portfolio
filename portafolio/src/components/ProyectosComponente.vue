...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Aplicación de Gestión de Inventarios para Empresas",
        descripcion: "Descripción: Una aplicación web que permite a las empresas gestionar su inventario de productos. Los usuarios pueden agregar, editar y eliminar productos, así como monitorear el stock en tiempo real.",
    ...
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Aplicación de Reserva de Citas para Clínicas o Consultorios",
        descripcion: "Descripción: Una plataforma en línea que facilita la reserva y gestión de citas para pacientes en clínicas o consultorios.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
        id: 3,
        src: proyecto3,
        titulo: "Aplicación de Tareas Colaborativas para Equipos de Trabajo",
        descripcion: "Descripción: Una aplicación de productividad que permite a los equipos de trabajo gestionar tareas y colaborar en proyectos en tiempo real.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
        id: 4,
        src: proyecto4,
        titulo: "Aplicación de Recetas de Cocina Personalizada",
        descripcion: "Descripción: Una aplicación móvil que permite a los usuarios buscar recetas de cocina según sus preferencias y restricciones alimenticias.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
])
